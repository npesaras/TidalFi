...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-accent focus:text-accent-foreground data-[highlighted]:bg-blue-600/15 data-[highlighted]:text-accent-foreground", // Or your desired text color for highlighted,
      className
    )}
    {...props}
  >
